...
/**
 */
public class PikachuGraphics extends JPanel implements ActionListener {
	...
	private PikachuLine line;
	private PikachuFrame frame;
	private Color backGroundColor = Color.lightGray;
	private int item;

	public PikachuGraphics(PikachuFrame frame, int row, int col) {
		this.frame = frame;
		this.row = row + 2;
		this.col = col + 2;
		item = row * col / 2;
